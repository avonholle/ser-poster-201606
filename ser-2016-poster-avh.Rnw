        ...
        \begin{block}{Introduction}
          ...
          \small{
            \begin{itemize}[align=left, labelindent=1pt,leftmargin=!]
                \item[\colouredcircle] Postnatal growth trajectory characteristics play an important role in life course analyses, and differences in growth according to prenatal exposures is one frequently used analytic approach.
