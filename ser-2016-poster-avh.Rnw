        ...
        \begin{block}{Introduction}
          ...
          \small{
            \begin{itemize}[align=left, labelindent=1pt,leftmargin=!]
                \item[\colouredcircle] Postnatal growth trajectory characteristics play an important role in life course analyses, and one common analytic approach is to assess differences in growth according to prenatal exposures.
...
\noindent\rule{20cm}{0.4pt}
        ...
        \item[\colouredcircle] After simulating weight values (10,000 iterations), we converted weight to WHO Z-score and percentiles and fit three models:
        \vskip0.5em
...
% ANOVA
        ...
        \item[\textbf{Model Terms}]
           ...
           \begin{labeling}{month6} %https://en.wikibooks.org/wiki/LaTeX/List_Structures
            ...
            \item [\bm{$m_{ij}$}] \footnotesize weight, Z-score, or percentile for person $i$ and time $j$
...
\begin{beamercolorbox}[center,wd=\textwidth]{postercolumn}
        ...
        \small{
          ...
          \begin{itemize}[align=left, labelindent=1pt,leftmargin=!]
            \item[\textbf{Parameter estimates}] Baseline weight differences lead to opposite direction of effect for Z-score compared to crude weight outcomes.
              \begin{itemize}
        ...
        \begin{block}{Conclusions}
          ...
          \begin{itemize}[align=left, labelindent=1pt,leftmargin=!]
            ...
            \item[\colouredcircle] Even at similar age and gender values, reference to a standard, WHO Z-scores, is not similar to crude weight values when assessing group differences in weight change over time.             \item[\colouredcircle] Supporting this conclusion, estimated group differences in weight change for all three outcomes only coincide in direction under certain conditions -- equivalent weight at baseline.
